 ...
 */
function konkin_info_preprocess_comment(&$variables, $hook) {
 ...
 */
function konkin_info_form_node_form_alter(&$form, &$form_state, $form_id) {
 ...
 */
function konkin_info_preprocess_menu_link(&$variables, $hook) {
 ...
 */
function konkin_info_imagemagick_arguments_alter(\Drupal\imagemagick\ImagemagickExecArguments $arguments, $command) {
 ...
 */
function konkin_info_preprocess_breadcrumb(&$variables) {
